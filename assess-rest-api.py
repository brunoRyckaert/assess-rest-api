...
r = requests.post("https://ryckaert.eu.auth0.com/oauth/token",None,{
	"client_id":data["client_id"],
	"client_secret":data["client_secret"],
	"audience":data["audience"],
	"grant_type":data["grant_type"] if data["grant_type"] else "password",
